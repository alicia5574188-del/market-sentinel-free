...
export default function Home() {
  ...
  return <main>
    ...
    <section className="settings-panel" hidden={activeTab !== "settings"}>
      ...
      {hasRuntimeSnapshot && <>
      <Setting title="策略系统" detail="四类环境由六种机制持续覆盖；势承、竭转、脉折和缓折具备PAPER权限，衡返与压跃保留双向观察。脉折与缓折分别处理中周期快速失速和较慢路径衰退。" value="6种机制" tone="online"/>
