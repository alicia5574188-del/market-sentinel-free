...
- PAPER reset to 1,000 U, separate completed-history clearing, bankruptcy rollover/reporting, idempotent D1 outbox, cached charts, 5m open-position lines, and 5m historical entry/exit review markers.
