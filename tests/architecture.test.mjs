...
test("Multi-Turn modules obey one-way architecture boundaries", async () => {
  const paths=["lib/multi-turn-engine.ts","lib/multi-turn-exit.ts","lib/multi-turn-exit-controller.ts","lib/multi-turn-hold-value.ts","lib/multi-turn-profit-protection.ts","lib/multi-turn-clock.ts","lib/multi-turn-entry-policy.ts"];
