import {
  classifyHte31AssetRegime as classifyStrategy2AssetRegime,
  classifyHte31MarketRegime as classifyShadowRegime,
} from "./hte31-regime.ts";
import type {
  Hte31AssetRegime as Strategy2AssetRegime,
  Hte31Candle as Candle,
  Hte31EntryCheck as EntryCheck,
  Hte31EntryPlan as EntryPlan,
  Hte31ExitRule as ExitRule,
  Hte31Input as Strategy2Input,
  Hte31MarketRegime as MarketRegime,
  Hte31Signal as Strategy2Signal,
  Hte31SignalMetric as SignalMetric,
  Hte31TradeSide as TradeSide,
} from "./hte31-types.ts";
