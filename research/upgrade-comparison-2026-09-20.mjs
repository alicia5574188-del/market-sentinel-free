...
const candidateSourceHashes = Object.fromEntries([
  ...
  'lib/live-parity.ts', 'lib/runtime-health.ts', 'lib/forward-store.ts', 'worker/index-clean.ts',
...
console.log(JSON.stringify({ schema: 'quant-upgrade-engineering-comparison-v1', baselineCommit: BASELINE,
  ...
  deploymentConclusion: 'Engineering improvement must not be substituted for the user\'s profitability-improvement condition. Net-profit / drawdown superiority remains unverified.',
