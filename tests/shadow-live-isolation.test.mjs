...
test("Strategy 2.0 is the sole new-entry authority while existing positions keep the normal lifecycle", async () => {
  ...
  assert.match(v2Strategy, /opportunity\.state\s*===\s*"TRADE"/);
