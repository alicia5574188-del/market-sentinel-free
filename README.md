...
- Countertrend validation starts only when the exact normal variant's latest six independent effective shadows contain at least three hard stops, both gross and after-cost totals are negative, and replaying the opposite direction at executable prices remains positive after complete modeled costs. A reverse geometry requiring more than an 85% break-even win rate is rejected. It then needs its own three-win or positive-six promotion result.
