...
test("direct market brain scanner is phased and cannot restart the whole old scan loop", async () => {
  ...
  assert.match(worker, /CLEAN_RUNTIME_VERSION = "direct-market-brain-v4-restored-core"/);
