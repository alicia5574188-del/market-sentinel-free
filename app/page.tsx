...
export default function Home() {
  ...
  return <main>
    ...
    <section className="settings-panel" hidden={activeTab !== "settings"}>
      ...
      {hasRuntimeSnapshot && <>
      <Setting title="策略系统" detail="四类环境由六种机制持续覆盖；势承、竭转、脉折和缓续具备PAPER权限，衡返与压跃保留双向观察。脉折按市场背景决定折返或延续，缓续只在较慢路径与全市场主潮一致时执行。" value="6种机制" tone="online"/>
