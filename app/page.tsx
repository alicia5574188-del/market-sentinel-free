...
export default function Home() {
  ...
  return <>
    ...
    {tab === "设置" && <section className="utility-card">
      ...
      <div className="setting-row"><div><strong>仓位 / 收益门槛</strong><span>先按止损风险定仓位，再限制保证金；TP2 扣除成本后仍须达到权益比例门槛</span></div><b>保证金 ≤ {settings?.riskPolicy.maxMarginAllocationPct ?? 20}% · TP2 ≥ {settings?.riskPolicy.minimumTp2NetProfitPct ?? 1.5}% · 同方向 ≤ {settings?.riskPolicy.maxSameSideLivePositions ?? 2} 仓</b></div>
